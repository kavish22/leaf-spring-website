          ...
          <section className="py-8 sm:py-20 bg-white" aria-labelledby="company-overview">
            <div className="container mx-auto px-4">
              ...
              <Tabs defaultValue="story" className="w-full">
                {/* Tabs Container - Increased height and improved spacing for mobile */}
                <div className="bg-gray-50 p-4 sm:p-3 rounded-xl shadow-sm mb-6 sm:mb-8 min-h-[200px] sm:min-h-fit">
                  <TabsList className="w-full h-full grid grid-cols-2 gap-4 sm:flex sm:gap-2">
                    {[
                      ...
                      <TabsTrigger 
                        key={tab.value}
                        value={tab.value}
                        className="flex items-center justify-center gap-2.5 px-4 py-5 sm:py-3.5 text-base sm:text-sm font-medium rounded-lg transition-all duration-300
