...
const product = {
  ...
  details: [
    ...
    "Control System: Digital interface with pressure monitoring",
    "Maximum Material Width: Up to 150mm",
    "Processing Length: Up to 2000mm"
  ],
  description: `Our Leaf Correction Press offers versatile capacity ranging from 15 to 60 tons, specifically designed for re-cambering and bend correction applications. Built with robust steel fabrication and featuring a digital control interface, this hydraulic press ensures precise and reliable leaf spring corrections.`,
  features: [
    "15-60 Ton variable capacity",
    "Digital control interface",
    "Hydraulic operation system",
    "Re-cambering capability",
    "Bend correction function",
