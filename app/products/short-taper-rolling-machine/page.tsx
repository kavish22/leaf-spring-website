...
const product = {
  ...
  description: `Our Short Taper Rolling Machine features a powerful 200-ton rolling station designed specifically for leaf spring applications. Capable of handling leaf thickness from 6-45mm and taper lengths up to 300mm, this machine delivers precise rolling control with manual operation flexibility.`,
  features: [
    "200 Ton rolling capacity",
    "6-45mm leaf thickness range",
    "300mm maximum taper length",
    "Manual loading/unloading",
    "Precision rolling control",
