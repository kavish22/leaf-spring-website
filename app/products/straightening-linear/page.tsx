...
const product = {
  ...
  description: `The Linear Straightening Machine combines 50-ton capacity with precision sliding mechanisms for superior lateral bend correction. Designed for hot condition operations, this hydraulic system delivers accurate and consistent straightening results across a wide range of applications.`,
  features: [
    "50 Ton straightening capacity",
    "Precision sliding mechanism",
    "Hydraulic operation system",
    "Hot condition capability",
    "Lateral bend correction",
