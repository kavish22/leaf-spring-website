...
const product = {
  ...
  description: `The Bush Pressing Machine combines 10-ton capacity with precise load/deflection control for optimal pressing operations. With a generous 650mm daylight and 400mm stroke, this hydraulic system ensures versatile and accurate bush pressing capabilities.`,
  features: [
    "10 Ton pressing capacity",
    "Load/deflection control system",
    "650mm daylight clearance",
    "400mm stroke length",
    "Hydraulic operation",
  ...
  gallery: [
    ...
    "/images/products/Bush Pressing-1.webp",
