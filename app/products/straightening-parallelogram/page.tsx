        ...
        <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <section className="relative h-[60vh] sm:h-[calc(100vh-56px)] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
              <motion.h1 
                className="text-4xl sm:text-5xl md:text-7xl font-bold mb-2 sm:mb-4 leading-[1.4] sm:leading-[1.4] bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300 pb-4"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
