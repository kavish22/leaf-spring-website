...
const product = {
  ...
  description: `Our Profile Checking Gauge is a precision measurement tool designed to handle components up to 1600mm in length. With its parabolic profile design and 20 measuring points, this gauge delivers exceptional accuracy with ±1 mm length tolerance for both hot and cold profile checking applications.`,
  features: [
    "1600mm maximum length capacity",
    "Parabolic profile measurement",
    "Hot and cold checking capability",
    "±1 mm length tolerance",
    "20-point measurement system",
  ...
  gallery: [
    ...
    "/images/products/Profile Checking-1.webp",
