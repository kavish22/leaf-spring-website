...
const product = {
  ...
  description: `The Hockey Bending Machine combines multiple force points (25+25+50 Ton) with precision sliding mechanisms for optimal bending control. Designed for hot condition applications and featuring robotic compatibility, this machine ensures accurate and consistent bending results.`,
  features: [
