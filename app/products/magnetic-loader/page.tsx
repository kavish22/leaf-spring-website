...
const product = {
  ...
  description: `Our Magnetic Loader combines a 500 kg lifting capacity with advanced magneto-pneumatic manipulation technology. Designed to handle stock sizes from 500x900 to 2500x900 with a 1000mm stroke, this loader provides efficient and safe material handling solutions.`,
  features: [
    "500 kg lifting capacity",
    "Magneto-pneumatic system",
    "1000mm stroke length",
