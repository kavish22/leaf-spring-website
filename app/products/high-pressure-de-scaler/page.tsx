...
const product = {
  ...
  description: `Our High Pressure De-scaler is engineered to deliver superior cleaning performance with its 300 BAR pressure system and sophisticated hydraulic controls. Featuring imported nozzles and advanced cleaning technology, this machine achieves an impressive 95-99% scale removal rate, making it ideal for steel mill applications.`,
  features: [
    "Powerful 300 BAR pressure system",
    "Sophisticated hydraulic control system",
    "Premium imported nozzles",
    "95-99% scale removal efficiency",
    "Steel mill grade construction",
  ...
  gallery: [
    ...
    "/images/products/De-scaler-1.png",
