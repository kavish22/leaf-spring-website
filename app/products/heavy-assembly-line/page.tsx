...
const product = {
  ...
  description: `Our Heavy Assembly Line is a state-of-the-art automated system designed specifically for automotive suspension systems assembly. With a robust 50 Ton capacity and featuring a dual piston telescopic press, this machine delivers precision and reliability in every operation.`,
  features: [
    "Dual piston telescopic press system",
    "Integrated batch code printing",
    "Automated operation sequence",
    "Advanced load/position sensors",
    "Vibration-free conveyor system",
                ...
                >
                  {media.includes('youtube.com') ? (
                    <div className="w-full h-full bg-gray-100 flex items-center justify-center">
                      <Image 
                        src="/images/products/Heavy assembly line.webp" 
                        alt="Video thumbnail"
                        fill
                        className="object-cover"
                      />
                      <PlayCircle className="absolute text-red-600 w-10 h-10" /> {/* Play icon overlay */}
                    </div>
                  ) : (
                    <Image
                      src={media}
