...
const product = {
  ...
  description: `The Scragging Machine offers versatile pressing capabilities from 5 to 50 tons, controlled through an advanced HMI system. With a 600mm stroke and efficient 15-second cycle time, this machine combines flexibility with productivity for various pressing applications.`,
  features: [
    "5-50 Ton variable capacity",
