...
const product = {
  ...
  description: `Our Z-bending Press-Inclined is a powerful 400-ton system featuring a sophisticated 4-cylinder design. Engineered for hot applications, this machine excels at precision bending of materials up to 60mm thickness, with its multi-cylinder configuration ensuring optimal force distribution and accuracy.`,
  features: [
    "400 Ton total pressing force",
    "4-cylinder configuration",
    "Hot application capability",
    "60mm maximum thickness capacity",
    "Advanced clamping system",
    "Precision bending control",
    "Optional 2-cylinder design",
