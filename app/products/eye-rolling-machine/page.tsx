...
const product = {
  ...
  description: `The Eye Rolling Machine is designed for precision curling operations up to 25mm thickness. With its two-stage curling mechanism and hydraulic operation system, this machine achieves perfect 180-degree curls in hot applications, ensuring consistent quality and reliability.`,
  features: [
    "25mm maximum thickness capacity",
    "Two-stage curling process",
    "180-degree curling capability",
    "Hot application operation",
